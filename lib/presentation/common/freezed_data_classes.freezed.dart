...
mixin _$RegisterObject {
  String get userName => throw _privateConstructorUsedError;
  String get contryMobileCode => throw _privateConstructorUsedError;
...
class _$RegisterObjectCopyWithImpl<$Res>
  ...
  $Res call({
    Object? userName = freezed,
    Object? contryMobileCode = freezed,
    ...
    return _then(_value.copyWith(
      userName: userName == freezed
          ...
          : userName // ignore: cast_nullable_to_non_nullable
              as String,
      contryMobileCode: contryMobileCode == freezed
          ? _value.contryMobileCode
          : contryMobileCode // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$_RegisterObject implements _RegisterObject {
  _$_RegisterObject(this.userName, this.contryMobileCode, this.mobileNumber,
      this.email, this.password, this.profilePicture);

  @override
  final String userName;
  @override
  final String contryMobileCode;
  @override
  ...
  @override
  String toString() {
    return 'RegisterObject(userName: $userName, contryMobileCode: $contryMobileCode, mobileNumber: $mobileNumber, email: $email, password: $password, profilePicture: $profilePicture)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.contryMobileCode, contryMobileCode) &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(userName),
      const DeepCollectionEquality().hash(contryMobileCode),
