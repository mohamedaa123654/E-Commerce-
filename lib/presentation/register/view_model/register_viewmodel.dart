...
class RegisterViewModel extends BaseViewModel
  ...
  register() async {
    ...
    (await _registerUseCase.execute(RegisterUseCaseInput(
            ...
            registerObject.contryMobileCode,
  ...
  setCountryCode(String countryCode) {
    if (countryCode.isNotEmpty) {
      //  update register view object
      registerObject = registerObject.copyWith(contryMobileCode: countryCode);
    } else {
      // reset code value in register view object
      registerObject = registerObject.copyWith(contryMobileCode: "");
    }
    validate();
  }
  ...
  bool _areAllInputsValid() {
    return registerObject.contryMobileCode.isNotEmpty &&
