...
class _AppServiceClient implements AppServiceClient {
  _AppServiceClient(this._dio, {this.baseUrl}) {
    baseUrl ??= 'http://mohamedabdelwahab.mocklab.io';
  }
  ...
  @override
  Future<AuthenticationResponse> register(userName, contryMobileCode,
      contryMobile, email, password, profilePicture) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = {
      'user_name': userName,
      'contry_mobile_code': contryMobileCode,
      'contry_mobile': contryMobile,
      'email': email,
      'password': password,
